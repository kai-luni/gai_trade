...
class RnnPredict:
    def train():
        ...
        lstm_price_one = CuDNNLSTM(64, name='LSTM_1', return_sequences=True)(input_price)
        do_price_1 = Dropout(rate=0.1)(lstm_price_one)
        lstm_price_two = CuDNNLSTM(32, name='LSTM_PRICE_TWO')(do_price_1)
        do_price_2 = Dropout(rate=0.1)(lstm_price_two)

        lstm_vol_one = CuDNNLSTM(64, name='LSTM_2', return_sequences=True)(input_vol)
        do_vol_1 = Dropout(rate=0.1)(lstm_vol_one)
        lstm_vol_two = CuDNNLSTM(32, name='LSTM_VOL_TWO')(do_vol_1)
        do_vol_2 = Dropout(rate=0.1)(lstm_vol_two)

        concatenated = Concatenate( name='Concatenate_1')([do_price_2,do_vol_2])
